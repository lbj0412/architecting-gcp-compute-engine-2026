...
<div class="card" style="margin-top: 10px; padding: 24px; border-left: 6px solid #1a73e8; text-align: left;">
  <h3 style="color: #1a73e8; font-size: 24px; margin-top: 0; text-align: left;">📍 Compute Engine VM 인스턴스 메뉴 이동</h3>
  <p style="font-size: 19px; color: #3c4043; line-height: 1.7; text-align: left; margin-bottom: 0;">
...
<div class="card" style="margin-top: 20px; padding: 30px; border-left: 6px solid #1a73e8;">
  ...
  <p style="font-size: 20px; color: #3c4043; line-height: 1.6; text-align: left;">
...
<div class="card" style="margin-top: 20px; padding: 30px;">
  ...
  <p style="font-size: 20px; color: #3c4043; line-height: 1.8; text-align: left;">
...
<div class="card" style="margin-top: 20px; padding: 30px; border-left: 6px solid #34a853;">
  ...
  <p style="font-size: 20px; color: #3c4043; line-height: 1.7; text-align: left;">
